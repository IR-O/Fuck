...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            stck = await message.reply_sticker("CAACAgUAAxkBAAEBPBpjoGMZgxQ7oJcQLBnXv6cMXCJYFwACPQkAAhZu4FSOER0z_xq3LywE")
            ...
            await update.effective_message.reply_photo(random.choice(START_IMG),PM_START_TEXT.format(escape_markdown(first_name),BOT_NAME,sql.num_users(),sql.num_chats())
